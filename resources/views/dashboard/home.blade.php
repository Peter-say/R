                                ...
                                <div class="card-body pb-0">
                                    <div class="pb-3 border-bottom mb-3">
                                        <div class="d-flex mb-3 flex-wrap align-items-end">
                                            <img class="rounded mr-3" src="{{ $dashboard_assets }}/images/customers/1.jpg"
                                                width="58" alt="">
                                            <div>
                                    ...
                                    <div class="pb-3 border-bottom mb-3">
                                        <div class="d-flex mb-3 flex-wrap align-items-end">
                                            <img class="rounded mr-3" src="{{ $dashboard_assets }}/images/customers/2.jpg"
                                                width="58" alt="">
                                            <div>
                                    ...
                                    <div class="pb-3">
                                        <div class="d-flex mb-3 flex-wrap align-items-end">
                                            <img class="rounded mr-3" src="{{ $dashboard_assets }}/images/customers/3.jpg"
                                                width="58" alt="">
                                            <div>
                                    ...
                                    <div class="testimonial-one owl-carousel">
                                        <div class="items">
                                            <a href="property-details.html"><img
                                                    src="{{ $dashboard_assets }}/images/testimonial/1.png" alt="#"
                                            ...
                                            <p class="fs-14 mt-3 mb-0">Lorem ipsum dolor sit amet, consectetur
