        ...
        <div class="container-fluid">
            <div class="form-head d-md-flex mb-sm-4 mb-3 align-items-start">
                <div class="mr-auto  d-lg-block">
                    ...
                    <p class="mb-0">Welcome to dashboard, {{ $user->full_name }}</p>
                </div>
                                ...
                                <div class="card-body">
                                    <div class="media d-sm-flex d-block align-items-center">
                                        ...
                                        <div class="media-body mb-sm-0 mb-3 mr-5">
                                            ...
                                            <?php
                                            $total_properties_last_month_record = $lastMonthPropertiesCount;
                                            $totalPropertiesCount = $total_properties->count();
                                            if ($total_properties_last_month_record != 0) {
                                                $percentageComplete = ($lastMonthPropertiesCount / $total_properties_last_month_record) * 100;
                                            } else {
                                            ...
                                            <div class="progress mt-3 mb-2" style="height:8px;">
                                                <div class="progress-bar bg-white progress-animated"
                                                    style="width: {{ $percentageComplete }}%; height:8px;"
                                                    role="progressbar">
                                                    <span class="sr-only">{{ $percentageComplete }}% Complete</span>
                                                </div>
                                            </div>
                                            <span
                                                class="fs-14">{{ $total_properties_last_month_record - $totalPropertiesCount }}
                                                more to break last month record</span>
                                        </div>

                                        <span class="fs-46 font-w500">{{ number_format($total_properties->count()) }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        @php
                            $total_properties_count = $total_properties->count();
                            $property_for_sale_count = $total_properties->where('stock_status', 'Sell')->count();
                            $property_for_rent_count = $total_properties->where('stock_status', 'Rent')->count();
                            ...
                            // Calculate the percentage for sale and for rent
                            $percentage_for_sale = $total_properties_count != 0 ? ($property_for_sale_count / $total_properties_count) * 100 : 0;
                            $percentage_for_rent = $total_properties_count != 0 ? ($property_for_rent_count / $total_properties_count) * 100 : 0;
                        @endphp
                                    ...
                                    <div class="media align-items-center">
                                        <div class="media-body mr-3">
                                            <h2 class="fs-36 text-black font-w600">
                                                {{ number_format($property_for_sale_count) }}</h2>
                                            <p class="fs-18 mb-0 text-black font-w500">Properties for Sale</p>
                                            {{-- <span class="fs-13">Target 3k/month</span> --}}
                                        </div>
                                        <div class="d-inline-block position-relative donut-chart-sale">
                                            <span class="donut1"
                                                data-peity='{ "fill": ["rgb(60, 76, 184)", "rgba(236, 236, 236, 1)"], "innerRadius": 38, "radius": 10}'>{{ $property_for_sale_count }}/8</span>
                                            <small class="text-primary">{{ number_format($percentage_for_sale) }}%</small>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="media align-items-center">
                                        <div class="media-body mr-3">
                                            <h2 class="fs-36 text-black font-w600">
                                                {{ number_format($property_for_rent_count) }}</h2>
                                            <p class="fs-18 mb-0 text-black font-w500">Properties for Rent</p>
                                            {{-- <span class="fs-13">Target 3k/month</span> --}}
                                        </div>
                                        <div class="d-inline-block position-relative donut-chart-sale">
                                            <span class="donut1"
                                                data-peity='{ "fill": ["rgb(55, 209, 90)", "rgba(236, 236, 236, 1)"], "innerRadius": 38, "radius": 10}'>{{ $property_for_rent_count }}/8</span>
                                            <small class="text-success">{{ number_format($percentage_for_rent) }}%</small>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="media align-items-center">
                                        ...
                                        <div class="d-inline-block position-relative donut-chart-sale">
                                            <span class="donut1"
                                                data-peity='{ "fill": ["rgb(55, 209, 90)", "rgba(236, 236, 236, 1)"], "innerRadius": 38, "radius": 10}'>{{ $percentage_per_customers }}/8</span>
                                            <small
                                                class="text-success">{{ number_format($percentage_per_customers) }}%</small>
                                            <span class="circle bgl-success"></span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="media align-items-center">
                                        ...
                                        <div class="d-inline-block position-relative donut-chart-sale">
                                            <span class="donut1"
                                                data-peity='{ "fill": ["rgb(55, 29, 90)", "rgba(236, 236, 236, 1)"], "innerRadius": 38, "radius": 10}'>{{ $percentage_per_agents }}/8</span>
                                            <small
                                                class="text-success">{{ number_format($percentage_per_agents) }}%</small>
                                            <span class="circle bgl-success"></span>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card-body pt-2 pb-0">
                            <div class="d-flex flex-wrap align-items-center">
                                ...
                                <div class="d-flex align-items-center">
                                    <svg class="mr-3" width="87" height="47" viewBox="0 0 87 47"
                                        ...
                                        <defs>
                                            <linearGradient id="paint0_linear" x1="44" y1="-36.4332"
                                                x2="44" y2="45.9686" gradientUnits="userSpaceOnUse">
                                                        ...
                                                        <td>
                                                            @if (!empty($user->avatar))
                                                                <img class="img-fluid"
                                                                    ...
                                                                    alt="">
                                                            @else
                                                                <img class="img-fluid" src="{{ $dashboard_assets }}/images/profile/avatar.jpeg"
                                                                    alt="" />
                                                            @endif
                                                        </td>
                                                        <td><span
                                                                class="badge light badge-success">{{ $user->role }}</span>
                                                        </td>
                                        ...
                                        <div class="card-body">
                                            <div id="monocromeChart">
                                                <svg width="100%" height="200">
                                                    <!-- Render a rectangle for Agents with percentage width -->
                                                    <rect x="0" y="10" width="{{ $percentage_per_agents }}%"
                                                        height="20" fill="#B655E4" />
                                                    <!-- Render a rectangle for Customers with percentage width -->
                                                    <rect x="{{ $percentage_per_agents }}%" y="10"
                                                        width="{{ $percentage_per_customers }}%" height="20"
                                                        fill="#FFB067" />
                                                </svg>
                                            </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body pb-0">
                                    <div class="pb-3 border-bottom mb-3">
                                        <div class="d-flex mb-3 flex-wrap align-items-end">
                                            <img class="rounded mr-3"
                                                src="{{ $dashboard_assets }}/images/customers/1.jpg" width="58"
                                                alt="">
                                            <div>
                                    ...
                                    <div class="pb-3 border-bottom mb-3">
                                        <div class="d-flex mb-3 flex-wrap align-items-end">
                                            <img class="rounded mr-3"
                                                src="{{ $dashboard_assets }}/images/customers/2.jpg" width="58"
                                                alt="">
                                            <div>
                                    ...
                                    <div class="pb-3">
                                        <div class="d-flex mb-3 flex-wrap align-items-end">
                                            <img class="rounded mr-3"
                                                src="{{ $dashboard_assets }}/images/customers/3.jpg" width="58"
                                                alt="">
                                            <div>
                                ...
                                <div class="card-body">
                                    <div class="testimonial-one owl-carousel">
                                        @php
                                            ...
                                            $latest_properties = Property::latest()->take(4)->get();

                                        @endphp
                                        @foreach ($latest_properties as $property)
                                            <div class="items">
                                                <a href="property-details.html"><img
                                                        src="{{ asset('storage/property/images/' . (json_decode($property->images)[0] ?? '')) }}"
                                                        alt="#" class="w-100 mw-100 mb-3 rounded"></a>
                                                <h5 class="fs-16 font-w600 mb-0"><a href="property-details.html"
                                                        class="text-black">{{ $property->address->country }},
                                                        {{ $property->address->state }}</a></h5>
                                                <span class="fs-14 d-block mb-4">{{ $property->address->street_address }},
                                                    {{ $property->address->zip }}</span>
                                                <a href="javascript:void(0);"
                                                    class="bgl-primary text-black p-1 pl-2 pr-2 mr-3 font-w600 rounded">
                                                    <svg class="mr-2" width="20" height="13"
                                                ...
                                                <a href="javascript:void(0);"
                                                    ...
                                                    <svg class="mr-2" width="13" height="15"
                                                ...
                                                <p class="fs-14 mt-3 mb-0">{{ Str::limit($property->description, 100) }}
                                                </p>
                                            </div>
                                        @endforeach
