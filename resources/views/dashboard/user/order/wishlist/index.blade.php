					...
					<div class="col-xl-12">
						...
						<div class="tab-content pt-4 bg-white">
							<div id="navpills-1" class="tab-pane active">
									...
									<div class="media align-items-center">
										...
										<div class="media-footer d-sm-flex d-block align-items-center">
											...
											<div class="edit ml-auto">
												<a href="javascript:void(0);" class="btn btn-outline-success rounded  mr-2">Move To Cart</a>
												<a href="javascript:void(0);" class="btn btn-outline-danger rounded">Delete</a>
											</div>
										</div>
									</div>
								</div>
								<div class="card review-table">
									<div class="media align-items-center">
										<img class="mr-3 img-fluid rounded" width="90"  src="public/images/customers/3.jpg" alt="DexignZone">
										<div class="media-body d-lg-flex d-block row align-items-center">
											<div class="col-xl-4 col-xxl-5 col-lg-12 review-bx">
												<span class="text-primary d-block">#C01234</span>
								...
								<div class="card review-table">
									<div class="media align-items-center">
										<img class="mr-3 img-fluid rounded" width="90"  src="public/images/customers/2.jpg" alt="DexignZone">
										<div class="media-body d-lg-flex d-block row align-items-center">
											<div class="col-xl-4 col-xxl-5 col-lg-12 review-bx">
												<span class="text-primary d-block">#C01234</span>
							...
							<div id="navpills-2" class="tab-pane">
								...
								<div class="card review-table">
									<div class="media align-items-center">
										<img class="mr-3 img-fluid rounded" width="90"  src="public/images/customers/5.jpg" alt="DexignZone">
										<div class="media-body d-lg-flex d-block row align-items-center">
											<div class="col-xl-4 col-xxl-5 col-lg-12 review-bx">
												<span class="text-primary d-block">#C01234</span>
												<h3 class="fs-20 text-black font-w600 mb-1">Peter Parkur</h3>
