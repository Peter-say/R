                        ...
                        <div class="profile-head">
                            ...
                            <div class="profile-info">
                                <div class="profile-photo">
                                    <img src="{{ $dashboard_assets }}/images/profile/profile.png"
                            ...
                            <div class="card">
                                ...
                                <div class="card-body pt-3">
                                    <div class="profile-blog">
                                        <img src="{{ $dashboard_assets }}/images/profile/1.jpg" alt=""
                                            class="img-fluid mb-4 w-100">
                                        <h4><a href="post-details.html" class="text-black">Darwin Creative Agency Theme</a>
                                        </h4>
                                ...
                                <div class="card-body pt-3">
                                    <div class="profile-interest">
                                        ...
                                        <div class="row sp4" id="lightgallery">
                                            <a href="public/images/profile/2.jpg" data-exthumbimage="images/profile/2.jpg"
                                                data-src="images/profile/2.jpg"
                                                class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
                                                <img src="{{ $dashboard_assets }}/images/profile/2.jpg" alt=""
                                                    class="img-fluid">
                                            </a>
                                            <a href="public/images/profile/3.jpg" data-exthumbimage="images/profile/3.jpg"
                                                data-src="images/profile/3.jpg"
                                                class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
                                                <img src="{{ $dashboard_assets }}/images/profile/3.jpg" alt=""
                                                    class="img-fluid">
                                            </a>
                                            <a href="public/images/profile/4.jpg" data-exthumbimage="images/profile/4.jpg"
                                                data-src="images/profile/4.jpg"
                                                class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
                                                <img src="{{ $dashboard_assets }}/images/profile/4.jpg" alt=""
                                                    class="img-fluid">
                                            </a>
                                            <a href="public/images/profile/3.jpg" data-exthumbimage="images/profile/3.jpg"
                                                data-src="images/profile/3.jpg"
                                ...
                                <div class="card-body pt-3">
                                    <div class="profile-news">
                                        <div class="media pt-3 pb-3">
                                            <img src="{{ $dashboard_assets }}/images/profile/5.jpg" alt="image"
                                        ...
                                        <div class="media pt-3 pb-3">
                                            <img src="{{ $dashboard_assets }}/images/profile/6.jpg" alt="image"
                                                class="mr-3 rounded" width="75">
                                            <div class="media-body">
                                                <h5 class="m-b-5"><a href="post-details.html"
                                                        class="text-black">Collection of textile samples</a></h5>
                                        ...
                                        <div class="media pt-3">
                                            <img src="{{ $dashboard_assets }}/images/profile/7.jpg" alt="image"
                                                class="mr-3 rounded" width="75">
                                            <div class="media-body">
                                                <h5 class="m-b-5"><a href="post-details.html"
                                                        class="text-black">Collection of textile samples</a></h5>
                                        ...
                                        <div id="my-posts" class="tab-pane fade active show">
                                            <div class="my-post-content pt-3">
                                                ...
                                                <div class="profile-uoloaded-post border-bottom-1 pb-5">
                                                    <img src="{{ $dashboard_assets }}/images/profile/8.jpg"
                                                        alt="" class="img-fluid">
                                                ...
                                                <div class="profile-uoloaded-post border-bottom-1 pb-5">
                                                    <img src="{{ $dashboard_assets }}/images/profile/9.jpg"
                                                        alt="" class="img-fluid">
                                                    <a class="post-title" href="post-details.html">
                                                        <h3 class="text-black">Collection of textile samples lay spread
                                                        </h3>
