...
<div class="nav-header">
    <a href="index.html" class="brand-logo">
        <img class="logo-abbr" src="{{ $dashboard_assets }}/images/logo.png" alt="">
        <img class="logo-compact" src="{{ $dashboard_assets }}/images/logo-text.png" alt="">
        <img class="brand-title" src="{{ $dashboard_assets }}/images/logo-text.png" alt="">
                        ...
                        <ul class="contacts">
                            ...
                            <li class="active dz-chat-user">
                                <div class="d-flex bd-highlight">
                                    <div class="img_cont">
                                        <img src="{{ $dashboard_assets }}/images/avatar/1.jpg"
                            ...
                            <li class="dz-chat-user">
                                <div class="d-flex bd-highlight">
                                    <div class="img_cont">
                                        <img src="{{ $dashboard_assets }}/images/avatar/2.jpg"
                                            class="rounded-circle user_img" alt="" />
                            ...
                            <li class="dz-chat-user">
                                <div class="d-flex bd-highlight">
                                    <div class="img_cont">
                                        <img src="{{ $dashboard_assets }}/images/avatar/3.jpg"
                                            class="rounded-circle user_img" alt="" />
                                        <span class="online_icon"></span>
                                    </div>
                                    <div class="user_info">
                            ...
                            <li class="dz-chat-user">
                                <div class="d-flex bd-highlight">
                                    <div class="img_cont">
                                        <img src="{{ $dashboard_assets }}/images/avatar/4.jpg"
                                            class="rounded-circle user_img" alt="" />
                                        <span class="online_icon offline"></span>
                                    </div>
                                    <div class="user_info">
                            ...
                            <li class="dz-chat-user">
                                <div class="d-flex bd-highlight">
                                    <div class="img_cont">
                                        <img src="{{ $dashboard_assets }}/images/avatar/5.jpg"
                                            class="rounded-circle user_img" alt="" />
                                        <span class="online_icon offline"></span>
                                    </div>
                                    <div class="user_info">
                                        ...
                                        <div class="timeline-panel">
                                            <div class="media mr-2">
                                                <img alt="image" width="50"
                                                    src="{{ $dashboard_assets }}/images/avatar/1.jpg">
                                            </div>
