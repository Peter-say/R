                            ...
                            <div class="agent-contact">
                                <div class="d-flex align-items-center p-4 border border-bottom-0">
                                    <div class="agent-contact-avatar me-3">
                                        <img class="img-fluid rounded-circle avatar avatar-xl" src="images/avatar/01.jpg"
                                            alt="">
                                    </div>
                    ...
                    <div class="col-lg-8 order-lg-1">
                        ...
                        <div class="property-description">
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <p>The home features private entry copper-clad door leading to salon with marble floors.
                                        Stunning great room has soaring 45 foot ceilings with glass windows, polished
                                        concrete floors, exposed brick & sculptural steel beams. The chef's kitchen has
                                        honed granite counters, high-end S/S appliances, French cabinets & gas range.</p>
                                    <p>Floor-to-ceiling windows accentuate the panoramic vistas that sweep across the Golden
                                        Gate Bridge, the downtown skyline, the artfully lit Bay Bridge and beyond. The floor
                                        plan features two bedroom suites, kitchen, living/dining room, two view terraces and
                                            ...
                                            <div class="card-header" id="headingOne">
                                                <h5 class="accordion-title mb-0">
                                                    <button class="btn btn-link d-flex ms-auto align-items-center"
                                                        ...
                                                        aria-expanded="true" aria-controls="collapseOne">First Floor <i
                                            ...
                                            <div id="collapseOne" class="collapse show accordion-content"
                                                ...
                                                <div class="card-body">
                                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cupiditate
                                                        labore amet nulla a nobis iste consequuntur laudantium natus
                                                        corporis, eveniet quo quidem perferendis sint illo autem, aut
                                                        incidunt enim libero.</p>
                                                    <img class="img-fluid" src="images/property/floor-plans-01.jpg"
                                                        alt="">
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div id="collapseTwo" class="collapse accordion-content"
                                                ...
                                                <div class="card-body">
                                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sit rem
                                                        esse qui voluptatem tempore nobis nihil, ex, odit vel exercitationem
                                                        aperiam provident consectetur. Ea, eos, blanditiis! Rem quia,
                                                        doloremque numquam.</p>
                                                    <img class="img-fluid" src="images/property/floor-plans-01.jpg"
                                                        alt="">
                                                </div>
                                            </div>
                                                ...
                                                <li class="d-flex">
                                                    ...
                                                    <ul class="list-unstyled list-inline ms-auto">
                                                        ...
                                                        <li class="list-inline-item m-0 text-warning"><i
                                                                class="fas fa-star fa-xs"></i></li>
                                                        <li class="list-inline-item m-0 text-warning"><i
                                                                class="fas fa-star-half-alt fa-xs"></i></li>
                                                    </ul>
                                                </li>
                                                <li class="d-flex">
