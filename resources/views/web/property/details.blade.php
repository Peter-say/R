      ...
      <div class="row">
        <div class="col-12">
          <ol class="breadcrumb mb-0">
            ...
            <li class="breadcrumb-item active"> <i class="fas fa-chevron-right"></i> <span> Stunning 2 bedroom home in
                village</span></li>
          </ol>
        </div>
      </div>
          ...
          <div class="col-lg-4 mb-5 mb-lg-0 order-lg-2">
            <div class="sticky-top">
              <div class="mb-4">
                ...
                <span class="d-block mb-3"><i class="fas fa-map-marker-alt fa-xs pe-2"></i>Virginia drive temple
                  hills</span>
              ...
              <div class="agent-contact">
                <div class="d-flex align-items-center p-4 border border-bottom-0">
                  <div class="agent-contact-avatar me-3">
                    <img class="img-fluid rounded-circle avatar avatar-xl" src="{{ $web_assets }}/images/avatar/01.jpg" alt="">
                  </div>
          ...
          <div class="col-lg-8 order-lg-1">
            ...
            <div class="property-description">
              <div class="row">
                ...
                <div class="col-sm-9">
                  <p>The home features private entry copper-clad door leading to salon with marble floors. Stunning
                    great room has soaring 45 foot ceilings with glass windows, polished concrete floors, exposed brick
                    & sculptural steel beams. The chef's kitchen has honed granite counters, high-end S/S appliances,
                    French cabinets & gas range.</p>
                  <p>Floor-to-ceiling windows accentuate the panoramic vistas that sweep across the Golden Gate Bridge,
                    the downtown skyline, the artfully lit Bay Bridge and beyond. The floor plan features two bedroom
                    suites, kitchen, living/dining room, two view terraces and ample storage space. </p>
                </div>
              </div>
            </div>
            <hr class="mt-4 mb-4 mb-sm-5 mt-sm-5">
                    ...
                    <div class="card">
                      <div class="card-header" id="headingOne">
                        <h5 class="accordion-title mb-0">
                          <button class="btn btn-link d-flex ms-auto align-items-center" data-bs-toggle="collapse"
                            data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">First Floor
                      ...
                      <div id="collapseOne" class="collapse show accordion-content" aria-labelledby="headingOne"
                        ...
                        <div class="card-body">
                          <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cupiditate labore amet nulla a
                            nobis iste consequuntur laudantium natus corporis, eveniet quo quidem perferendis sint illo
                            autem, aut incidunt enim libero.</p>
                          <img class="img-fluid" src="{{ $web_assets }}/images/property/floor-plans-01.jpg" alt="">
                        </div>
                      </div>
                    </div>
                    <div class="card">
                      <div class="card-header" id="headingTwo">
                        <h5 class="accordion-title mb-0">
                          <button class="btn btn-link d-flex ms-auto align-items-center collapsed"
                      ...
                      <div id="collapseTwo" class="collapse accordion-content" aria-labelledby="headingTwo"
                        data-bs-parent="#accordion">
                        <div class="card-body">
                          <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sit rem esse qui voluptatem
                            tempore nobis nihil, ex, odit vel exercitationem aperiam provident consectetur. Ea, eos,
              ...
              <div class="row">
                ...
                <div class="col-sm-9">
                  <div class="embed-responsive embed-responsive-16by9">
                    <iframe width="546" height="315" src="{{ $web_assets }}/https://www.youtube.com/embed/kacyaEXqVhs"
                      ...
                      <ul class="property-list list-unstyled mb-0">
                        <li class="d-flex">
                          ...
                          <ul class="list-unstyled list-inline ms-auto">
                            ...
                            <li class="list-inline-item m-0 text-warning"><i class="fas fa-star fa-xs"></i></li>
                            <li class="list-inline-item m-0 text-warning"><i class="fas fa-star fa-xs"></i></li>
                            <li class="list-inline-item m-0 text-warning"><i class="fas fa-star-half-alt fa-xs"></i>
                            </li>
                          </ul>
                        </li>
                        <li class="d-flex">
            ...
            <div class="property-statistics">
              <div class="row">
                ...
                <div class="col-sm-9">
                  <img class="img-fluid" src="{{ $web_assets }}/images/property/views--statistics.jpg" alt="">
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="property-item">
              ...
              <div class="property-details">
                <div class="property-details-inner">
                  <h5 class="property-title"><a href="property-detail-style-01.html">Ample apartment at last floor </a>
                  </h5>
                ...
                <div class="property-btn">
                  ...
                  <ul class="property-listing-actions list-unstyled mb-0">
                    <li class="property-compare"><a data-bs-toggle="tooltip" data-placement="top" title="Compare"
                        href="#"><i class="fas fa-exchange-alt"></i></a></li>
                    <li class="property-favourites"><a data-bs-toggle="tooltip" data-placement="top" title="Favourite"
            ...
            <div class="property-item">
              ...
              <div class="property-details">
                <div class="property-details-inner">
                  ...
                  <span class="property-address"><i class="fas fa-map-marker-alt fa-xs"></i>Newport st. mebane,
                    nc</span>
