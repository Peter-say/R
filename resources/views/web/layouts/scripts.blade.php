...
Javascript -->
  ...
  <script src="{{asset("/web/jquery-3.6.0.min.js")}}"></script>
  <script src="{{asset("/web/popper/popper.min.js")}}"></script>
  <script src="{{asset("/web/bootstrap/bootstrap.min.js")}}"></script>

  <!-- Page JS Implementing Plugins (Remove the plugin script here if site does not use that feature)-->
  <script src="{{asset("/web/jquery.appear.js")}}"></script>
  <script src="{{asset("/web/counter/jquery.countTo.js")}}"></script>
  ...
  <script src="{{asset("/web/custom.js")}}"></script>
